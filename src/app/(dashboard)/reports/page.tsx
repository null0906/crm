        ...
        <div className="rounded-2xl border border-[var(--border-subtle)] bg-white p-5 shadow-sm">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-black tracking-[-0.04em] text-[var(--text-primary)]">Analyst Reports</h1>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-1 text-xs font-semibold text-[var(--text-secondary)]">{getRoleDisplayName(user.role.name)}</p>
                  </div>
