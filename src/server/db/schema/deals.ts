...
export const deals = pgTable(
  'deals',
  {
    ...
    projectActualEndDate: date('project_actual_end_date'),
    projectProgressPercent: integer('project_progress_percent').default(0),
    ...
    primaryContactTitle: varchar('primary_contact_title', { length: 150 }),
  ...
  (t) => [
    ...
    index('idx_deals_partner').on(t.referredByPartnerId),
    index('idx_deals_end_date').on(t.projectEndDate).where(sql`${t.deletedAt} IS NULL`),
    index('idx_deals_project').on(t.linkedProjectId),
