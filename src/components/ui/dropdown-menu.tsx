...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-[180px] overflow-hidden rounded-xl bg-white p-1.5',
        'border border-slate-200/80',
        'shadow-[0_8px_24px_rgba(16,24,40,0.08),_0_2px_8px_rgba(16,24,40,0.04)]',
        'text-slate-700',
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      'px-2.5 py-1.5 text-xs font-semibold text-slate-400 uppercase tracking-widest',
      inset && 'pl-8',
      className
    )}
    {...props}
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      'relative flex cursor-default select-none items-center rounded-lg py-1.5 pl-8 pr-2.5 text-sm',
