  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'shadow-[0_16px_48px_rgba(16,24,40,0.12),_0_4px_12px_rgba(16,24,40,0.06)]',
...
const DialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn(
      'flex flex-col-reverse gap-2 sm:flex-row sm:justify-end mt-5 pt-4 border-t border-slate-100',
      className
    )}
    {...props}
  />
