...
export function ContactReminderDialog({
  ...
  const placeholder = useMemo(
    () => (contactName ? `Follow up with ${contactName} in 2 days` : 'Follow up with this contact'),
    [contactName]
  );
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Set Contact Reminder</DialogTitle>
          <DialogDescription>
            Create a follow-up reminder for this contact. The reminder will go only to the task owner when it becomes due.
          </DialogDescription>
        </DialogHeader>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            <Label htmlFor="contact-reminder-subject">Reminder</Label>
            <Input
              id="contact-reminder-subject"
              value={subject}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <Label htmlFor="contact-reminder-due-date">Due date</Label>
              <Input
                id="contact-reminder-due-date"
                type="date"
                value={dueDate}
            ...
            <div className="space-y-1.5">
              <Label htmlFor="contact-reminder-priority">Priority</Label>
              <select
                id="contact-reminder-priority"
                value={priority}
          ...
          <div className="space-y-1.5">
            <Label htmlFor="contact-reminder-notes">Notes</Label>
            <Textarea
